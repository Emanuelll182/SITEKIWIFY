  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cta: "gradient-cta text-cta-foreground hover:scale-105 glow-cta font-semibold transition-bounce",
        hero: "bg-accent text-accent-foreground hover:bg-accent/90 font-medium border border-accent/20",
        "outline-primary": "border border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-smooth"
      },
      size: {
